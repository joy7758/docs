...
<Tabs>
  ...
  curl -fsSL https://github.com/langchain-ai/langchain-skills/archive/main.tar.gz \
    ...
    && cp -R /tmp/langchain-skills-main/config/skills/langsmith-{trace,dataset,evaluator} ./.claude/skills/ \
  ...
  curl -fsSL https://github.com/langchain-ai/langchain-skills/archive/main.tar.gz \
    ...
    && cp -R /tmp/langchain-skills-main/config/skills/langsmith-{trace,dataset,evaluator} ./.deepagents/skills/ \
    && rm -rf /tmp/langchain-skills-main
  ```
  ```bash [Windows (WSL/Git Bash)]
  curl -fsSL https://github.com/langchain-ai/langchain-skills/archive/main.tar.gz \
  ...
  curl -fsSL https://github.com/langchain-ai/langchain-skills/archive/main.tar.gz \
    | tar -xz -C /tmp \
    && mkdir -p ~/.deepagents/langchain_agent/skills \
    && cp -R /tmp/langchain-skills-main/config/skills/langsmith-{trace,dataset,evaluator} ~/.deepagents/langchain_agent/skills/ \
    && rm -rf /tmp/langchain-skills-main
  ```
  ```bash [Windows (WSL/Git Bash)]
  curl -fsSL https://github.com/langchain-ai/langchain-skills/archive/main.tar.gz \
