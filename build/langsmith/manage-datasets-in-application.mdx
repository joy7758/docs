...
On the [**Playground**](/langsmith/prompt-engineering-concepts#playground) page, select **Set up Evaluation**, click **+New** if you're starting a new dataset or select from an existing dataset.
